...
<body>
    ...
    <div class="container-fluid p-4">
        <div class="card">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold">View Student Marks</h5>
            </div>
            <div class="card-body">
                <!-- Step 1: Mark Type Selection -->
                <div class="row mb-4 no-print">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Step 1: Select Marks Type</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="marksType" id="theoryMarks" value="theory" checked>
                                            <label class="form-check-label" for="theoryMarks">
                                                <i class="fas fa-book me-2"></i> View Theory Marks
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="marksType" id="practicalMarks" value="practical">
                                            <label class="form-check-label" for="practicalMarks">
                                                <i class="fas fa-flask me-2"></i> View Practical Marks
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="marksType" id="bothMarks" value="both">
                                            <label class="form-check-label" for="bothMarks">
                                                <i class="fas fa-th-list me-2"></i> View Both (Theory + Practical)
                                            </label>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mb-4 no-print">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Step 2: Select Semester & Subject</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
    ...
    <script src="view_marks.js"></script>
</body>
</html>